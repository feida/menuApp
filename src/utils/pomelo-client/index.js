(function() {
  var Protocol = require('./lib/pomelo-protocol/protocol');
  var protobuf = require('./lib/pomelo-protobuf/protobuf');
  var EventEmitter = require('./lib/component-emitter/index');
  ...
  pomelo.init = function(params, cb, errCallback) {
    initCallback = cb;
    ...
    connect(params, url, cb, errCallback);
  };
  ...
  var connect = function(params, url, cb, errCallback) {
    ...
    var onclose = function(event) {
      ...
      if(!!params.reconnect && reconnectAttempts < maxReconnectAttempts) {
        ...
        reconncetTimer = setTimeout(function() {
          connect(params, reconnectUrl, cb, errCallback);
        }, reconnectionDelay);
        reconnectionDelay *= 2;
      }
    };
  ...
  //Initilize data used in pomelo-client client
